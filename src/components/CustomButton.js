...
const CustomButton = ({ text }) => {
  return (
    <div className="relative w-48 h-12 border-2 m-auto my-5 dark:border-white border-black rounded-3xl overflow-hidden group cursor-pointer shadow-custom-button">
